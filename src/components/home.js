    ...
    >
      <div className="h-full lg:h-screen relative">
        <div className="lg:h-screen flex flex-col justify-center items-center lg:items-start ">
          <h1 className="block text-3xl md:text-6xl leading-tight text-primary uppercase font-bold tracking-wide">
            Anuj&nbsp;&nbsp;Mody
          </h1>
          ...
          <div className="lg:w-full">
            <div className="lg:flex lg:items-baseline lg:justify-between">
              <div className="w-screen text-xl md:text-3xl text-gray-400 mt-0 text-center lg:text-justify">
                <Typewriter
                  options={{
                    strings: ["Mobile App Developer", "Team Lead"],
                    autoStart: true,
                    loop: true,
                  }}
                />
              ...
              <div className="flex justify-center mt-4 md:mt-4 ">
                <a
                  href="https://twitter.com/androanuj"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block mx-3 shadow-xl p-2 bg-socialBg flex justify-center hover:bg-black-dark hover:text-primary"
                >
                  <svg
                    className="w-6 h-6 fill-current text-gray-400  hover:text-primary"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 97.637 97.637"
                  >
                    <path d="M97.523 18.526a.482.482 0 00-.568-.131 39.055 39.055 0 01-9.153 2.776 20.299 20.299 0 007.143-10.035.484.484 0 00-.709-.565 39.147 39.147 0 01-12.18 4.701 20.408 20.408 0 00-14.644-6.219c-11.204 0-20.318 9.114-20.318 20.317 0 1.355.131 2.697.391 4-15.518-.958-30.028-8.408-39.894-20.509a.484.484 0 00-.795.062 20.303 20.303 0 00-2.751 10.215 20.3 20.3 0 007.649 15.896 19.42 19.42 0 01-7.089-2.292.483.483 0 00-.721.413l-.002.26c0 8.946 5.895 16.801 14.282 19.409a19.514 19.514 0 01-6.754-.098.486.486 0 00-.553.623A20.314 20.314 0 0028.494 71.39c-6.785 4.971-14.805 7.59-23.279 7.59-1.561 0-3.133-.093-4.673-.274a.492.492 0 00-.514.317.485.485 0 00.195.572 56.693 56.693 0 0030.664 8.988c35.625 0 56.913-28.938 56.913-56.914 0-.779-.015-1.554-.046-2.327a40.519 40.519 0 009.802-10.235.486.486 0 00-.033-.581z" />
                  </svg>
                </a>
                <a
                  href="https://www.linkedin.com/in/anuj-mody-a82b60143/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block p-2 bg-socialBg flex justify-center hover:bg-black-light hover:text-primary"
                >
                  <svg
                    className="w-6 h-6 fill-current text-gray-400  hover:text-primary"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://medium.com/@androanuj_7874"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block mx-3 p-2 bg-socialBg flex justify-center hover:bg-black-light hover:text-primary"
                >
                  <svg
                    className="w-6 h-6 fill-current text-gray-400  hover:text-primary"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="w-full text-secondary-light flex justify-center lg:justify-start mt-4">
              <a
                href="https://docs.google.com/document/d/1wYqZOScxrqmq2A2aONSupINSijkzsJhB57WvsrhQRZM/edit?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="px-10 py-2 bg-primary text-gray-300 rounded-md focus:outline-none focus:shadow-outline lg:hover:bg-yellow-700 text-lg shadow-lg font-semibold"
              >
                View CV
              </a>
            </div>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            {myInfo.map((item, index) => (
              <div className="flex flex-1 flex-col text-center">
                <span className="text-secondary-light font-bold text-1xl lg:text-lg">
                  {item.key}
                </span>
                <span className="text-secondary-light font-light text-1xl lg:text-lg">
                  {item.value}
                </span>
              </div>
            ))}
